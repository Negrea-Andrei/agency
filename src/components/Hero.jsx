...
const Hero = ({ theme }) => {
  return (
    <div id="home" className="bg-[#aadefc] dark:bg-dark dark:text-white relative-z-20">
      <div className="container min-h-[800px] flex">
        <div className="grid place-items-center grid-cols-1 sm:grid-cols-2">
          ...
          <div className="order-2 sm:order-1 space-y-5 sm:pr-32">
            ...
            <button
              className="bg-primary text-black px-6 py-2 rounded-md duration-300 cursor-pointer"
              data-aos="fade-up"
              data-aos-delay="2000"
            >
              Let's GO!
